...
echo " \n";
echo "_______I_L_M_U__S_A_N_T_E_T___B_A_N_T_E_N________\n";
echo " \n";
echo "______________S_A_U_N_G__B_A_B_E_H_______________\n";
echo " \n";
echo " \n";
echo "      ===========================================
     |JUDUL      :SANTET CALL                    |
     |AUTHER     :GANTENG                        |
     |PENDUKUNG  :™иs°d̸αRαᴮᵀᴺ                    |
     |SARAN      :GUNAKAN AWALAN 08              |
     |TUJUAN     :BIKIN EMOSI ORANG              |
      ===========================================\n";
echo " \n";
sleep ('0.4');
echo "===> MASUKAN NOMORNYA TARGETNYA KONTOL = ";
$no = get();
$n = new prankCall($no);
$n->run();
